...
export function OTPhasesStepper({ phases, onCompletePhase, readOnly = false }: OTPhasesStepperProps) {
  ...
  const handleComplete = async () => {
    if (!selectedPhase || !onCompletePhase) return
  ...
  // Calculate progress
  const completedCount = phases.filter(p => p.estado === "completed").length
    ...
    <>
                ...
                <div key={phase.id} className="relative pl-8 pb-6">
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between gap-2">
                      ...
                      {phase.estado === "in_progress" && !readOnly && onCompletePhase && (
                        <Button
                          size="sm"
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent className="max-w-lg">
          <DialogHeader>
            <DialogTitle>
              Finalizar {selectedPhase?.nombre}
            </DialogTitle>
            <DialogDescription>
            ...
            <div>
              ...
              <div className="border-2 border-dashed rounded-lg p-6 text-center hover:border-primary/50 transition-colors">
                <input
                  ...
                  className="hidden"
                  id="evidence-upload-ot"
                />
                <label
                  htmlFor="evidence-upload-ot"
