...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    icon: Calendar,
    roles: ["admin", "receptionist", "workshop_manager", "customer"],
  },
  {
    title: "Recepción",
    href: "/dashboard/recepcion",
    icon: CalendarCheck,
    roles: ["admin", "receptionist", "workshop_manager"],
  },
  {
    title: "Diagnóstico",
    href: "/dashboard/diagnostico",
    icon: Stethoscope,
    roles: ["admin", "mechanic", "workshop_manager"],
  },
  {
    title: "Órdenes de Trabajo",
    href: "/dashboard/ot",
    icon: ClipboardList,
    roles: ["admin", "receptionist", "mechanic", "workshop_manager"],
  },
  {
    title: "Inventario",
    href: "/dashboard/inventario",
    icon: Package,
    roles: ["admin", "workshop_manager"],
  },
  {
    title: "Taller",
    href: "/dashboard/taller",
    icon: Wrench,
    roles: ["admin", "workshop_manager", "mechanic"],
  },
  {
    title: "Facturación",
